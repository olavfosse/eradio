...
- =eradio-play-random-channel= play a random channel from =eradio-channels=, see [[https://github.com/olav35/eradio#variables][Variables]].
- =eradio-play-random-and-different-channel= play a random channel from =eradio-channels= that is different from =eradio-current-channel=, see [[https://github.com/olav35/eradio#variables][Variables]].
